...
# Same code but for another picture
...
scaleFactor = 1.1, #scaleFactor will decrease by 10% the image and will search in a smaller image for another face. Smaller value=higher accuracy
